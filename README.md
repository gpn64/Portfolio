...
![Statistics](https://img.shields.io/badge/Statistics-4A4A4A?style=for-the-badge&logo=databricks&logoColor=white)
...
**Design choices:** TSX-only scope eliminates currency risk and ensures full TFSA eligibility on all positions. The fundamental gate runs before momentum to avoid selecting names accelerating into deteriorating financials. A historical simulation mode lets you pass any past date to reconstruct what the screener would have recommended on that day.
